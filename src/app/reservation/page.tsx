        ...
        <div className='container'>
          ...
          <div className='grid md:grid-cols-4 gap-8 text-center'>
            ...
            <div className='flex flex-col items-center'>
              ...
              <h3 className='text-xl font-semibold mb-2'>현장 진단</h3>
              <p className='text-muted-foreground text-sm'>
            ...
            <div className='flex flex-col items-center'>
              ...
              <h3 className='text-xl font-semibold mb-2'>맞춤 견적</h3>
              <p className='text-muted-foreground text-sm'>
            ...
            <div className='flex flex-col items-center'>
              ...
              <h3 className='text-xl font-semibold mb-2'>서비스 진행</h3>
              <p className='text-muted-foreground text-sm'>
        ...
        <div className='container max-w-4xl mx-auto'>
          ...
          <Accordion type='single' collapsible className='w-full'>
            <AccordionItem value='item-1'>
              <AccordionTrigger>견적 비용이 발생하나요?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value='item-2'>
              ...
              <AccordionContent>
                네, 저희 스타방역공사는 환경부의 정식 승인을 받은 안전한
            ...
            <AccordionItem value='item-4'>
              <AccordionTrigger>주말에도 서비스가 가능한가요?</AccordionTrigger>
              <AccordionContent>
